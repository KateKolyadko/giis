...
class Object3DViewerDialog(QDialog):
    ...
    def get_selection(self):
        if self.cube_button.isChecked():
            return r"D:\BSUIR\sem6\GIIS\lab\objects\cube.txt"  # Raw string, no leading space
        elif self.pyramid_button.isChecked():
            return r"D:\BSUIR\sem6\GIIS\lab\objects\pyramid.txt"  # Raw string, no leading space
        return None
